  ...
  return <section className="min-h-screen flex items-center justify-center px-6 py-12 gradient-subtle">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-2 text-center md:text-left">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">Nazywam się Barbara Wojnarowska. Towarzyszę osobom, które chcą lepiej zrozumieć siebie i swoje emocje. W bezpiecznej przestrzeni możesz zatrzymać się, nabrać sił i ruszyć w stronę zmian, które są dla Ciebie ważne.</p>
