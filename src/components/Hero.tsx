...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 py-12 gradient-subtle">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-2 md:order-1 flex justify-center">
          <div className="relative">
            <img
              ...
              alt="Dr Anna Kowalska - Psychoterapeutka"
              className="w-80 h-96 object-cover rounded-2xl shadow-warm"
            />
        ...
        <div className="order-1 md:order-2 text-center md:text-left">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Jestem Anna i wiem, że pierwszy krok to często naтруdniejniejszy. 
            Zapraszam Cię do miejsca, gdzie możesz być sobą, gdzie Twoje emocje 
            są ważne, a Ty sam jesteś ekspertem od swojego życia.
          </p>
